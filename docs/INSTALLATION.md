...
1. **Download the Latest Release**
   - Visit our [GitHub Releases Page](https://github.com/john20xdoe/onthespot-fork/releases).
...
2. **Install OnTheSpotRebuilt**
   - **Windows**: Run the downloaded `.exe`.
   - **MacOS**: Open the `.dmg`, follow the instructions listed in README.txt, and drag `OnTheSpotRebuilt.app` into your `Applications` folder.
...
If you prefer to build OnTheSpotRebuilt yourself, follow these steps.
...
1. **Install Python and Download the Source Code**
   ...
   - The source code can be downloaded through github or through the commands below:
     ...
     ```bash
     git clone https://github.com/john20xdoe/onthespot-fork
     cd onthespot-fork
     ```
...
3. **Install and Launch OnTheSpotRebuilt**
...
```bash
python3 -m pip install git+https://github.com/john20xdoe/onthespot-fork --force
