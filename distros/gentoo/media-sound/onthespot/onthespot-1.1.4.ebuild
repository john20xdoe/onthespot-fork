...
if [[ ${PV} == *9999 ]]; then
	inherit git-r3
	EGIT_REPO_URI="https://github.com/john20xdoe/onthespot-fork.git"
else
	SRC_URI="https://github.com/john20xdoe/onthespot-fork/archive/refs/tags/v${PV}.tar.gz
			 -> ${P}.tar.gz"
	KEYWORDS="~amd64"
fi

DESCRIPTION="qt based music downloader written in python (OnTheSpotRebuilt fork)"
HOMEPAGE="https://github.com/john20xdoe/onthespot-fork"
