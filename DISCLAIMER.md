...
OnTheSpot is an open-source project licensed under [GPL-2.0](https://github.com/john20xdoe/onthespot-fork/blob/main/LICENSE) and its code is distributed for educational and personal use only.
